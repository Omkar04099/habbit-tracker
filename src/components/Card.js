    ...
    <div className="Card">
      <div className={styles.container}>
        <div className={styles.textLogo} style={{ alignItems: "center" }}>
          <img
            src="https://cdn-icons-png.flaticon.com/128/9434/9434493.png"
            width={30}
            height={30}
            alt="hash"
          />
        ...
        <Link to={`weekview/${habbitId}`} style={{textDecoration:'none',color:'inherit'}}>
      ...
      {/* <div>{flag && <WeekView taskId={habbitId} />}</div> */}
      <ToastContainer />
    </div>
  );
}
